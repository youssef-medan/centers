    ...
    <div class="py-12 p-1 m-3 rounded bg-white">
        <form action="{{ route('employees.index') }}">
            <div class="w-1/2 text-center" style="margin:  0 auto">
                ...
                <x-text-input value="{{ request()->get('search') }}" placeholder="employee Name Or branch Name"
            ...
            <div class="p-6 text-gray-900">
                <div class="flex justify-end">
                    <x-primary-button class="bg-red-800">
                        <a href="{{ route('employees.create') }}">{{ __('app.Add New employee') }}</a>
                    </x-primary-button>
                </div>
                <!-- component -->
                    ...
                    <div class="overflow-x-auto sm:mx-0.5 lg:mx-0.5 ">
                        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8 ">
                            <div class="overflow-hidden  ">
                                <table class="min-w-full border-spacing-y-48">
                                    <thead class="bg-gray-200 border-b rounded-xl">
                                        <tr>
                                            ...
                                            <th scope="col"
                                                class="text-sm font-medium text-gray-900 px-2 py-1 text-left">
                                                user id
                                            </th>
                                            <th scope="col"
                                                class="text-sm font-medium text-gray-900 px-5 py-4 text-left">
                                        ...
                                        @forelse ($employees as $employee)
                                            <tr
                                                ...
                                                <td
                                                    ...
                                                    {{ $loop->iteration }}</td>
                                                <td
                                                    class="text-sm text-gray-900 font-light px-5 py-4 whitespace-nowrap">
                                                    {{ $employee->uname }}
                                                </td>
                                                <td
